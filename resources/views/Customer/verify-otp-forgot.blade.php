...
<head>
    ...
    <title>H&R Ice Cream - Verify Code</title>
...
<body>
    ...
    <div class="right">
        <div class="container">
            ...
            <form id="verify-form" action="{{ route('customer.forgot-password.verify-otp.submit') }}" method="POST">
                @csrf
            ...
            <div class="resend-row">
                Didn't receive code?
                <form id="resend-form" action="{{ route('customer.forgot-password.resend-otp') }}" method="POST" style="display:inline;">
                    @csrf
